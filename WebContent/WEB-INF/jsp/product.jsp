		...
		<div class="span18 last">
			...
			<div class="info">
				<dl>
					<dt>亿家价:</dt>
					<dd>
						<strong>￥：${p.shopPrice }元/份</strong>
							参 考 价：
							<del>￥${p.marketPrice }元/份</del>
					</dd>
				</dl>
					<dl>
						<dt>促销:</dt>
