...
<script type="text/javascript">
	...
	function change() {
		document.getElementById("captchaImage").src=
			"${pageContext.request.contextPath}/checkImg.action?"+new Date().getTime();//加入时间戳，防止走缓存
	}
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${pageContext.request.contextPath }/user/regist.action"  method="post" novalidate="novalidate">
						<table>
							<tbody><tr>
								<th>
							...
							<tr>
								...
								<td>
									<input type="text" name="name" class="text" maxlength="20" autocomplete="off">
								</td>
							</tr>
							<tr>
								<th>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="captcha" name="captcha" class="text captcha" maxlength="4" autocomplete="off"><img id="captchaImage" onclick="change()" class="captchaImage" src="${pageContext.request.contextPath}/checkImg.action" title="点击更换验证码">
