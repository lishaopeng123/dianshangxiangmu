...
<!-- 					<div class="hotProductAd">
			<img src="${pageContext.request.contextPath}/image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
						...
						<c:forEach var="p" items="${plist }">
									<li>
										<a href="${pageContext.request.contextPath}/product/findProductBypid.action?pid=${p.pid}" target="_blank"><img src="${pageContext.request.contextPath}/${p.image}" data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg" style="display: block;"></a>
									</li>
						</c:forEach>			
						</ul>
